...
| 4   | [Titanic - Machine Learning from Disaster (TensorFlow Decision Forests)](hthttps://github.com/hifizhhh/Titanic---Machine-Learning-from-Disaster-TensorFlow-Decision-Forests-) | This project is a solution to the classic Titanic survival prediction challenge on Kaggle. It uses TensorFlow Decision Forests (TFDF) with custom preprocessing, feature engineering, hyperparameter tuning, and ensemble techniques to build robust models.                                   | Numpy, Pandas, Matplotlib, Seaborn Tensorflow        | [Competition on Kaggle](https://www.kaggle.com/competitions/titanic)                       |
